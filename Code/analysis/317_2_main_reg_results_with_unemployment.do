...
import delimited using ///
	"$data/constructed data/labordemand_dataset_stata_with_unemployment.csv", ///
...
preserve 
	...
	keep job_vacancies_*_num county_id period treatment_shift unemployment_lag1 unemployment_lag2 unemployment_lag3
	...
	graph export "$output/dcdh_solar_labor_demand_shift_revisions_with_unemployment.pdf", replace
	...
	graph export "$output/dcdh_wind_labor_demand_shift_revisions_with_unemployment.pdf", replace

...
gen county_id = floor(census_tract_id / 1000000)	
...
preserve 
	...
	graph export "$output/dcdh_binary_solar_investment_shift_excl_la_chi.pdf", replace
	...
	graph export "$output/dcdh_binary_wind_investment_shift_excl_la_chi.pdf", replace
...
do "$code/Code/analysis/322_2_main_reg_results_excl_la_chi.do"

esttab dyn_* lab_* using "$output/reg_invest_lab_dem_excl_la_chi.tex", ///

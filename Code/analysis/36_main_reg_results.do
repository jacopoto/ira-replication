...
preserve 
	...
	graph export "$output/dcdh_binary_solar_investment_shift.pdf", replace
	...
	graph export "$output/dcdh_binary_wind_investment_shift.pdf", replace
...
do "$code/Code/analysis/36_2_main_reg_results.do"

esttab dyn_* lab_* using "$output/reg_invest_lab_dem.tex", ///

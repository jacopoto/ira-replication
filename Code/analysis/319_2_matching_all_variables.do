...
import delimited using "$data/constructed data/matched_panel_labor_demand_LASSO.csv", clear
...
preserve 
	...
	graph export "$output/dcdh_solar_labor_demand_shift_matched_all_variables.pdf", replace
	...
	graph export "$output/dcdh_wind_labor_demand_shift_matched_all_variables.pdf", replace

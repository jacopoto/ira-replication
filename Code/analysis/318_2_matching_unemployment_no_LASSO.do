...
import delimited using "$data/constructed data/matched_panel_labor_demand_unemployment_no_LASSO.csv", clear
...
preserve 
	...
	graph export "$output/dcdh_solar_labor_demand_shift_matched_unemployment_no_LASSO.pdf", replace
	...
	graph export "$output/dcdh_wind_labor_demand_shift_matched_unemployment_no_LASSO.pdf", replace
